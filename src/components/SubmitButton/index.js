...
export default function SubmitButton({disabled, url, email, groupNumber}){
    
    var [btnDisable, setBtnDisable] = React.useState(disabled)
    ...
    var [responseContent, setResponseContent] = React.useState({
      type: "success", title: "Submission successful", text: "Thanks for your submission. Have a good semester break."})
    ...
    return (
        ...
        >
            ...
            <SubmitInProgress open={isOpen}/>
            {responseOpen?(<ResponseDialogue content={responseContent}/>):<></>}
        </Box>)
}

function SubmitInProgress({open}) {
